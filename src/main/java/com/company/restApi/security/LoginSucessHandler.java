...
import static com.company.restApi.utils.GlobalAttributes.TIMESTAMP_COOKIE_NAME;

@Component
public class LoginSucessHandler extends SavedRequestAwareAuthenticationSuccessHandler {

    private static final String USER_HOME_PAGE_URL = "/uploads";
    private static final String ADMIN_HOME_PAGE_URL = "/uploads";
